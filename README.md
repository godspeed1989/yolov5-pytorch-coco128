https://blog.csdn.net/moxibingdao/article/details/107704462

## 测试

python detect.py --weights ./weights/yolov5s.pt --save-txt --view-img

## coco128 训练
python train.py --img 512 --batch 2 --epochs 3 --data ./data/coco128.yaml --cfg yolov5s.yaml
